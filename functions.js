...
function vender(cooldownBoost,sellBoost, sellBoost2){
    if(biscoitos>30 && cont>30+cooldownBoost&& keyIsDown(81)){
        cont =0
        dinheiro = dinheiro+5*sellBoost
        biscoitos = biscoitos-10*sellBoost2
    }
}

function comprarRestaurante(){
    var token =1
if(keyIsDown(70) && dinheiro>=20 && token==1){
    caixaRestaurante1.shapeColor = 'lime'
    dinheiro = dinheiro -10
    token =0
    chosenrest =  1
}
if(keyIsDown(71)&& dinheiro>=20 && token==1){
...
if(keyIsDown(72)&& dinheiro>=20 && token==1){
    caixaRestaurante3.shapeColor = 'lime'
    dinheiro = dinheiro -20
    token=0
    chosenrest =  3
}
if(keyIsDown(74)&& dinheiro>=100 && token==1){
